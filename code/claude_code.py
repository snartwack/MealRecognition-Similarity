...
#openrouter api key setup (using openrouter to access claude)
...
def compare_food(image_filename):
    ...
    #prompt for claude to output number from [0,1] (prompt made by ai)
    prompt = f"""
    ...
    """
    #receiving claude output and returning
